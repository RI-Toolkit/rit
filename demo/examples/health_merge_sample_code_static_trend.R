...
health_stats(model_type, n_states=3, init_age=65, init_state=0, trans_probs=trans_probs_3state)
# health_stats(model_type, n_states=3, init_age=65, init_state=0, simulated_path = simulated_path_3)
# health_stats(model_type, n_states=3, init_age=65, init_state=0, trans_probs=trans_probs_3state, simulated_path = simulated_path_3)

health_stats(model_type, n_states=5, init_age=65, init_state=0, trans_probs=trans_probs_5state)
