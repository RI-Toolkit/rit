...
l3_F=simulate_life_table(n_states=3, model_type, param_file=param_file_3, init_age, female, year = 2012, init_state = 0, wave_index = 8,latent=0,n_sim=10,cohort=100000,mean=TRUE)
l5_F=simulate_life_table(n_states=5, model_type, param_file=param_file_5, init_age, female, year = 2012, init_state = 0, wave_index = 8,latent=0,n_sim=10,cohort=100000,mean=TRUE)
...
health_stats(model_type, n_states=3, init_age=65, init_state=0, trans_probs= NULL , simulated_path = NULL, female, year, wave_index, latent, param_file = param_file_3, n = 10)
health_stats(model_type, n_states=5, init_age=65, init_state=0, trans_probs= NULL , simulated_path = NULL, female, year, wave_index, latent, param_file = param_file_5, n = 10)
