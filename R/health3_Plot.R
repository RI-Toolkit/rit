...
#' @noRd
#'
health3_surv_prob <- function(init_state, init_age, closure_age, target_age, trans_probs, end_state = NULL, freq = 1) {
...
#' @noRd
#'
health3_prob_plots <- function(init_age, closure_age, init_state, trans_probs, freq = 1) {
