...
#' a matrix of lifetime paths simulations, generated by \code{simulate_health_state_paths}, only needed for static and trend models.
#'
#' @param female
...
if (model_type=='S' | model_type=='T'){
  ...
  if (!is.null(simulated_path) & !is.null(trans_probs)) {
    ...
    # simulate path
    SP <- health3_simulate_paths(trans_probs, init_age, 0, 10000)
  }
...
#'
#' @param simulated_path
#' matrix containing lifetime path simulations from \code{simulate_health_state_paths} function.
#'
#' @param female
#' 0 for male, 1 for female, compulsory variable for frailty model
#'
