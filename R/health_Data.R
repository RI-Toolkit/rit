#' Parameters of 5-state Cox Regression Model estimated from Australian SDAC
#'
#' A dataset containing the parameters of the 5-state static and trend cox regression
#' models estimated with the 1998-2018 Australian Survey of Disability, Aging
#' and Carers (SDAC) data.
#'
...
#' }
#' @source Park K., Sherris, M., 2023. Actuarial modelling of Australian population
#' retirement risks: an Australian functional disability and health state model.
#' Decisions in Economics and Finance, 1-41.
"AU_SDAC_5"
...
#'    \item{trans12}{parameter estimate for MD to Dead transition}
#' }
#' @source Sherris, M., Wei, P., 2021. A multi-state model of functional
#' disability and health status in the presence of systematic trend and uncertainty.
#' North American Actuarial Journal, 25(1), 17-39.
"US_HRS_5"
