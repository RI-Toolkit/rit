...
create_policy_AP <- function(balance, init_age = 65, drawdown_rate = c(rep(0.05,10), rep(0.06,5), rep(0.07,5), rep(0.09,5), rep(0.11,5), rep(0.14,17))) {
...
create_policy_LA <- function(benefit, defer = 0, increase = 0) {
...
create_policy_PA <- function(benefit, size, interest) {
